    ...
    return (
        <div className={`portslat h-screen relative pb-16 bg-white`}>
            ...
            <div className="md:px-32 p-6 md:text-md text-sm">
                ...
                <hr />
                <div className="p-3">
                    <h1 className="font-bold text-lg my-6 md:text-xl">Should I wash my bikini by hand or in the washing machine?</h1>
                    <p className="text-sm md:text-[16px]">
                ...
                <div className="p-3">
                    <h1 className="font-bold text-lg my-6 md:text-xl">Machine-washing your swimwear</h1>
