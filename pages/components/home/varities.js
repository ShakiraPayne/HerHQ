...
export default function Varities() {
    return (
        <div className="p-3 text-2xl block font-bold bg-gray-100 nerkoone">
            <h1 className="text-center my-10 mt-6">Shop Now</h1>
            <Link href={'/buy'}>
                <div className="grid md:grid-cols-4 gap-4 grid-cols-2 md:px-16 md:gap-6 text-xl sm:text-md greatvibes text-center">
