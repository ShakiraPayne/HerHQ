...
export default function Ambassador() {
    return (
        <div className="pt-16 bg-gray-100">
            ...
            <div className="flex overflow-x-scroll snap-x md:flex-wrap bg-white content-center md:p-6 gap-6 place-items-center place-content-center w-screen flex-shrink-0">
