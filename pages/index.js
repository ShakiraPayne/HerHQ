  ...
  return (
    <div className={`portslat h-screen relative pb-16 bg-white`}>
      ...
      <div className="flex items-center justify-center min-h-2/3 video-container">
        <video onPlay={ () => {this.controls = false;} } className="md:hidden block" onContextMenu={e => e.preventDefault()} autoPlay={true} loop muted={true} preload="auto" controls={false}>
        ...
        <video onPlay={ () => {this.controls = false;} } className="hidden md:block w-2/3" onContextMenu={e => e.preventDefault()} autoPlay={true} loop muted={true} preload="auto" controls={false}>
